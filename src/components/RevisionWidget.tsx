          ...
          {items.map((it) => (
            ...
            >
              ...
              <div className="flex shrink-0 flex-col gap-1.5">
                <a
                  href={`/mock-test?subject=${encodeURIComponent(it.subject)}&topic=${encodeURIComponent(it.topic)}&count=5&mode=revision&autostart=1`}
                  className="rounded-md bg-primary px-2.5 py-1.5 text-center text-xs font-semibold text-primary-foreground transition hover:opacity-90"
                >
                  Revise now
                </a>
                <button
                  ...
                  className="rounded-md border border-border bg-card px-2.5 py-1 text-[11px] font-medium text-foreground/80 transition hover:border-primary/40 hover:text-foreground focus-ring"
                >
